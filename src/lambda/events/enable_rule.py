...
from src.common.events import enable_rule
...
def handler(event, context):
  ...
  try:
    ...
    reply_message(interface, 'Failed to enable rule - input may be invalid.')
    raise

  reply_message(interface, 'Successfully enabled rule!')
